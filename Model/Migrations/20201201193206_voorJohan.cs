...
{
    public partial class voorJohan : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KennismakingTekst = table.Column<string>(type: "nvarchar(225)", maxLength: 225, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "GemeenteId");
                    table.ForeignKey(
                        name: "FK_Personen_Personen_PersoonId1",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Aangepast = table.Column<byte[]>(type: "varbinary(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                table: "Personen",
                columns: new[] { "PersoonId", "AdresId", "AfdelingId", "FamilieNaam", "Geblokkeerd", "GeboorteDatum", "GeboorteplaatsId", "Geslacht", "LoginAantal", "LoginNaam", "LoginPaswoord", "PersoonId1", "PersoonType", "TaalId", "TelefoonNr", "VerkeerdeLoginsAantal", "VoorNaam" },
                values: new object[,]
                {
                    { 1, 1, 1, "Janssens", false, new DateTime(1980, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1730, 0, 0, "Jan", "Baarden", null, "M", 1, "02/2222222222", 0, "Jan" },
                    { 2, 1, 1, "Pieters", false, new DateTime(1980, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1731, 0, 0, "Piet", "Baarden", null, "M", 1, "02/2222222222", 0, "Piet" },
                    { 3, 1, 1, "Jorissens", false, new DateTime(1980, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1731, 0, 0, "Joris", "Baarden", null, "M", 1, "01/11111111", 0, "Joris" },
                    { 4, 1, 1, "Cornelis", false, new DateTime(1980, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1792, 0, 0, "Korneel", "Baarden", null, "M", 1, "02/2222222222", 0, "Korneel" }
                });
